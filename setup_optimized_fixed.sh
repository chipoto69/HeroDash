...
chmod +x "$HERO_DASHBOARD_DIR/hero_core_optimized_fixed.sh"
chmod +x "$HERO_DASHBOARD_DIR/launch_hero_optimized_fixed.sh"
...
chmod +x "$HERO_DASHBOARD_DIR/monitors/agents_monitor.py"
chmod +x "$HERO_DASHBOARD_DIR/monitors/code_activity_monitor.py"
chmod +x "$HERO_DASHBOARD_DIR/monitors/token_usage_analyzer.py"

echo "✓ Made all scripts executable"

# Create symlink for hero command to use optimized version
if [ ! -f "$HERO_DASHBOARD_DIR/hero_optimized" ]; then
    ln -s "$HERO_DASHBOARD_DIR/launch_hero_optimized_fixed.sh" "$HERO_DASHBOARD_DIR/hero_optimized"
